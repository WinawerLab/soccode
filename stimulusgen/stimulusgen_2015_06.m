%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Stimulus generation for 2015-06-xx
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Examine the bpfilter
load(fullfile(rootpath, 'data', 'input', 'stimuli.mat'), 'bpfilter');

% About this filter:
% - 21 pixels wide
% - 1 cycle per 6 pixels; peak is at 3-to-4 cycles per filter size
% - I have absolutely no idea how to generate it

figure; imshow(bpfilter, []);

figure; plot(bpfilter(10, :), 'o-');
set(gca, 'XTick', linspace(1, 26, 26));
xlabel('Space domain')

f = fft(bpfilter(10,:));
figure; plot(abs(f), 'o-');
set(gca, 'XTick', linspace(1, 26, 26))
xlabel('Freq domain; cycles per image');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Examine the Gabor filter
gaborCpfovs = 45;
fovs = 800;
gaborFiltSize = 32;
...
% About this filter:
% - 32 pixels wide
% - 1 cycle per 11 pixels; peak is at 3-to-4 cycles per filter size
% - I also have no idea how to generate this

figure; imshow(gaborfilt, []);

figure; plot(gaborfilt(:, 16), 'o-');
set(gca, 'XTick', linspace(1, 32, 32));
xlabel('Space domain')
